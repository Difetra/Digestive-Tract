...
func _ready():
    ...
    small_intestine.position = Vector2(0, 100)
    large_intestine = Intestine.new(config_large)
    large_intestine.position = Vector2(0, 200)
    ...
    small_intestine.segments[0].input = stomach
    large_intestine.segments[0].input = small_intestine.segments[-1]
    
    stomach.output = small_intestine.segments[0]
    small_intestine.segments[-1].output = large_intestine.segments[0]
